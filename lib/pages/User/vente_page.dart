...
class VentePageUser extends StatefulWidget {
  const VentePageUser({super.key});

  @override
  State<VentePageUser> createState() => _VentePageState();
}

class _VentePageState extends State<VentePageUser> with TickerProviderStateMixin {
